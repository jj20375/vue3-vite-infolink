<template>
    <div v-if="!useDefaultLayoutRouteNames.includes(route.name as string)" class="flex flex-col min-h-screen">
...
const i18n = useI18n();
// 使用預設樣板路由名稱
const useDefaultLayoutRouteNames = ref(["login", "forgot-password"]);
