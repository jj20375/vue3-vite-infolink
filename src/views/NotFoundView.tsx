        ...
        return () => (
            <section class="h-full container flex justify-center items-center">
                <div class="flex flex-col md:flex-row gap-6 md:gap-12 items-center">
                    ...
                    <div>
                        <div class="font-medium text-yellow-900 text-center md:text-start text-[28px] mb-2">頁面不存在</div>
                        <div class="text-center md:text-start text-[15px]">很抱歉，您所訪問之頁面不存在，可能網址錯誤或失效。</div>
                    </div>
                </div>
            </section>
        );
